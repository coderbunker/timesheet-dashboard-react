...
class App extends Component {
  ...
  fetchData = async () => {
    ...
    try {
      ...
      // HERE YOU CAN DO ALL DATA MANIPULATION
      console.log({ allOrganizations, allMonthlyGrosses });
    } catch (e) {
      console.log(e);
    }
  };
  ...
  render() {
    ...
    //                 style={{ height: `${parseFloat(m.node.total) / result.highestTotal * 100}%` }}
    //               />
